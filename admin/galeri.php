...
while($row = mysqli_fetch_assoc($result)){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit_galeri.php?id_galeri=<?php  echo $row['id_galeri']; ?>"
                                                    class="btn btn-primary">Edit</a>
                                                <a href="hapus_galeri.php?id_galeri=<?php echo $row['id_galeri']; ?>"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Tambah Data Galeri Hotel</h4>
                    ...
                    <form action="tambah_galeri.php" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="keterangan" class="form-control" placeholder="Namar">
                            </div>
                            <div class="form-group">
                                <label>Foto</label>
