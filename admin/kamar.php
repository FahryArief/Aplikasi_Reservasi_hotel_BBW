                    ...
                    <form method="post" action="tambah_kamar.php" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="no_kamar" class="form-control" placeholder="Tipe Kamar">
                            </div>
                            <div class="form-group">
                                <label>Harga Kamar</label>
                                <input type="text" name="harga" class="form-control" placeholder="Harga Kamar">
                            </div>
                            <div class="form-group">
                                <label>Jumlah Kamar</label>
                                <input type="text" name="jmlhkamar" class="form-control" placeholder="Harga Kamar">
                            </div>
                            <div class="form-group">
                                <label>Stok Kamar</label>
                                <input type="text" name="stok" class="form-control" placeholder="Harga Kamar">
                            </div>
                            <div class="form-group">
