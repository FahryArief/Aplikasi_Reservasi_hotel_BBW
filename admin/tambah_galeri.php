...
if ($foto !="") {
   ...
   if (!$result) {
    ...
    echo "<script>alert('Data Berhasil Di Tambahkan');window.location='galeri.php';</script>";
   }
   
}
 else {
    echo "<script>alert('Extensi gambar harus berupa .jpg atau .png');window.location='galeri.php';</script>";
}
  }else {
